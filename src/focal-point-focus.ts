import { FocalPoint, styleAssign, CONTAINER_STYLES, IMAGE_STYLES, ABSOLUTE_STYLES, FOCAL_POINT_X, FOCAL_POINT_Y } from "./types/focal-point.types";
...
export class FocalPointFocus {
    ...
    setFocus(focal: FocalPoint) {
        ...
        if (this.img.complete && this.img.naturalWidth > 0) {
            ...
            this.waitOnImageToLoad(this.img)
                .then(() => {
                    this.processImage(focal);
                });
        }
